...
pub use registry::{
    ...
    lookup_datum_epsg, lookup_ellipsoid_code_for_datum, lookup_epsg, lookup_operation,
    lookup_vertical_epsg, lookup_vertical_grid_operation, operation_candidates_between,
