...
use proj_epsg_format::{
    ...
    METHOD_ALBERS, METHOD_AMERICAN_POLYCONIC, METHOD_CASSINI_SOLDNER, METHOD_COLOMBIA_URBAN,
    METHOD_EQUAL_EARTH, METHOD_EQUIDISTANT_CYL, METHOD_HOTINE_OBLIQUE_MERCATOR_A,
    METHOD_HOTINE_OBLIQUE_MERCATOR_B, METHOD_KROVAK_MODIFIED_NORTH_ORIENTATED,
    METHOD_KROVAK_NORTH_ORIENTATED, METHOD_LAEA, METHOD_LAEA_SPHERICAL, METHOD_LCC,
    METHOD_LCC_1SP_VARIANT_B, METHOD_LCC_MICHIGAN, METHOD_MERCATOR, METHOD_OBLIQUE_STEREO,
    METHOD_POLAR_STEREO, METHOD_TRANSVERSE_MERCATOR, METHOD_WEB_MERCATOR, OP_CONCATENATED,
...
fn method_code_to_id(code: i64) -> Option<u8> {
    match code {
        ...
        9818 => Some(METHOD_AMERICAN_POLYCONIC),
