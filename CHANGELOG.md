...
- add the Laborde Oblique Mercator projection (EPSG method 9813, the Tananarive / Laborde Grid Madagascar CRSs including the Paris-meridian EPSG:29701), growing projected CRS coverage to 5,235; verified against C PROJ's test vectors and a same-datum reference corpus point
